...
export const courses: Course[] = [
  ...
  },
  {
    ...
    slug: "logic-pro-kickstart",
    title: "Logic Pro Kickstart",
    ...
    learningOutcomes: [
      ...
      "Program complex MIDI patterns and groove",
      "Design punchy drums and core synthesizer sounds",
      "Organize professional sessions with master templates",
    ],
    prerequisites: "None - perfect for absolute beginners",
    whatsIncluded: [
      "Learn from Industry Expert Vaibhav Sahay with 17+ years experience in Logic Pro",
      "Professional production, arrangement, and mixing techniques",
      "Free templates, sample packs, and project resources",
      "Access to academy partners with exclusive discounts on music production tools and products",
      "Industry exposure, mentorship, and career guidance",
      "Professional certification and alumni network for long-term collaboration and opportunities",
      "Join a growing creative alumni network",
    ],
    postCourseBenefits: [
      {
        category: "Learning Resources",
        items: [
          "Professional Logic Pro Templates",
      ...
      },
      {
        category: "Expert Guidance",
        items: [
          "Direct Mentorship (Vaibhav Sahay)",
          "Workflow Optimization",
          "Sound Design Foundations",
        ],
      },
    ...
    sessions: [
      { sessionNumber: 1, title: "DAW Setup and Workflow", duration: 2, objectives: ["Setting up a professional working environment and understanding efficient workflows."] },
      { sessionNumber: 2, title: "Signal Flow Fundamentals", duration: 2, objectives: ["Understanding how audio moves through a project from input to output."] },
      { sessionNumber: 3, title: "Routing and Track Management", duration: 2, objectives: ["Using buses, groups, and track stacks for better control and organization."] },
      { sessionNumber: 4, title: "Session Organization", duration: 2, objectives: ["File structure, naming systems, and building a personal master template."] },
      { sessionNumber: 5, title: "MIDI Programming", duration: 2, objectives: ["Creating drum patterns and musical ideas beyond basic sequencing."] },
      { sessionNumber: 6, title: "Groove and Timing", duration: 2, objectives: ["Working with swing, timing variations, and human feel."] },
      { sessionNumber: 7, title: "Drum Design", duration: 2, objectives: ["Layering drums to achieve punch, clarity, and balance."] },
      { sessionNumber: 8, title: "Groove Manipulation", duration: 2, objectives: ["Extracting and applying groove; timing adjustments for feel."] },
      { sessionNumber: 9, title: "Introduction to Synthesis", duration: 2, objectives: ["Basic principles of sound generation using synthesizers."] },
      { sessionNumber: 10, title: "Sound Shaping Tools", duration: 2, objectives: ["Using envelopes, filters, and modulation."] },
      { sessionNumber: 11, title: "Layering Techniques", duration: 2, objectives: ["Building depth and richness through layering."] },
      { sessionNumber: 12, title: "Designing Core Sounds", duration: 2, objectives: ["Creating bass and lead sounds from scratch."] },
    ],
  },
  {
    id: "logic-pro-mastery",
    slug: "logic-pro-mastery",
    title: "Logic Pro Mastery",
    ...
    learningOutcomes: [
      ...
      "Execute professional mixing and mastering workflows",
      "Create complex arrangements with advanced energy flow",
      "Navigate the music industry with a professional career roadmap",
    ],
    prerequisites: "None - starts from foundations to mastery",
    whatsIncluded: [
      "Learn from Industry Expert with over 17+ years experience in Logic Pro",
      "1 year Apple Creator Studio - Get Logic Pro, Final Cut Pro, MainStage, Compressor, Motion in a complete bundle worth INR 4000",
      ...
      "Access to academy partners with exclusive discounts on music production tools and products",
      "Industry exposure, mentorship, and career guidance",
      "Career roadmap support, preparing you for paths such as Music Producer, Beatmaker, Mix Engineer, Ableton Live Performer, Studio Assistant, Independent Artist, or Freelance Sound Designer",
      "Professional certification and alumni network for long-term collaboration and opportunities",
    ],
    postCourseBenefits: [
      {
      ...
      },
      {
        ...
        items: [
          ...
          "Mentorship (Vaibhav Sahay)",
        ],
      },
      {
        category: "Roles You'll Be Prepared For",
        items: [
          "Music Producer / Beatmaker",
          "Mix Engineer",
    ...
    sessions: [
      ...
      { sessionNumber: 12, title: "Designing Core Sounds", duration: 2, objectives: ["Creating bass and lead sounds from scratch."] },
      // Month 2
      { sessionNumber: 13, title: "Pads and Textures", duration: 2, objectives: ["Creating atmospheric elements and background layers."] },
      { sessionNumber: 14, title: "Sound Library Development", duration: 2, objectives: ["Organizing and building a personal sound bank."] },
      { sessionNumber: 15, title: "Sampling Techniques", duration: 2, objectives: ["Using samplers creatively for production."] },
      { sessionNumber: 16, title: "Time and Pitch Processing", duration: 2, objectives: ["Stretching and pitching audio accurately."] },
      { sessionNumber: 17, title: "Audio Warping and Flex Editing", duration: 2, objectives: ["Aligning audio with tempo and correcting timing."] },
      { sessionNumber: 18, title: "Resampling Methods", duration: 2, objectives: ["Transforming existing sounds into new material."] },
      { sessionNumber: 19, title: "Song Structure", duration: 2, objectives: ["Understanding common track structures and forms."] },
      { sessionNumber: 20, title: "Transitions and Energy Flow", duration: 2, objectives: ["Managing movement between sections."] },
      { sessionNumber: 21, title: "Automation Techniques", duration: 2, objectives: ["Using automation to create variation and dynamics."] },
      { sessionNumber: 22, title: "Advanced Arrangement", duration: 2, objectives: ["Maintaining interest and clarity in complex projects."] },
      { sessionNumber: 23, title: "Recording and Comping", duration: 2, objectives: ["Managing takes and selecting the best performances."] },
      { sessionNumber: 24, title: "MIDI Expression", duration: 2, objectives: ["Improving realism using velocity, modulation, and articulation."] },
      // Month 3
      { sessionNumber: 25, title: "Timing Correction", duration: 2, objectives: ["Refining performances while preserving feel."] },
      { sessionNumber: 26, title: "Advanced Editing & Refinement", duration: 2, objectives: ["Polishing takes and ensuring professional quality editing."] },
      { sessionNumber: 27, title: "Equalization", duration: 2, objectives: ["Balancing frequencies and cleaning up mixes."] },
      { sessionNumber: 28, title: "Compression", duration: 2, objectives: ["Controlling dynamics and enhancing impact."] },
      { sessionNumber: 29, title: "Bus Processing", duration: 2, objectives: ["Using group processing and parallel techniques."] },
      { sessionNumber: 30, title: "Stereo Imaging", duration: 2, objectives: ["Creating width, depth, and spatial balance."] },
      { sessionNumber: 31, title: "Reverb Techniques", duration: 2, objectives: ["Designing space within a mix."] },
      { sessionNumber: 32, title: "Delay and Modulation", duration: 2, objectives: ["Adding movement and character."] },
      { sessionNumber: 33, title: "Mastering Chain", duration: 2, objectives: ["Final processing and limiting."] },
      { sessionNumber: 34, title: "Loudness and Referencing", duration: 2, objectives: ["Working with LUFS and comparing to industry standards."] },
      { sessionNumber: 35, title: "File Delivery", duration: 2, objectives: ["Exporting stems and preparing final files."] },
      { sessionNumber: 36, title: "Collaboration and Final Project", duration: 2, objectives: ["Professional workflow and final project submission."] },
    ],
  },
